...
exports.hidessignup_alert = exports.alert = exports.signup_alert = void 0;

var signup_alert = function signup_alert() {
  ...
  el.appendChild(img);
  el.appendChild(el1);
  document.querySelector('#signup').insertBefore(el, document.querySelector('#signup').firstElementChild);
  window.setTimeout(function () {
    document.querySelector('#signup').removeChild(el);
  }, 3000);
};

exports.signup_alert = signup_alert;

var alert = function alert(msg, type) {
  var block = document.createElement('div');
  block.className = "alert alert--".concat(type);
...
var hidessignup_alert = function hidessignup_alert() {
  document.querySelector('#signup').removeChild(document.querySelector('#signup').firstElementChild);
};

exports.hidessignup_alert = hidessignup_alert;
...
exports.start_login = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              window.setTimeout(function () {
                (0, _alert.alert)('You are logged in', 'success');
...
exports.start_logout = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  var res;
...
exports.start_signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, email, password, confirmPassword, role, worksFor, post) {
    var response;
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 11:
            if (response.data.status == 'success') {
              (0, _alert.hidessignup_alert)();
              (0, _alert.alert)('Please verify your account on mail', 'success');
              window.setTimeout(function () {
                window.location.assign('/EC/mainpage');
              }, 2000);
            }
...
exports.start_forgetpassword = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.alert)('Please check your mail to reset your password', 'success');
              window.setTimeout(function () {
                window.location.assign('/EC/mainpage');
              }, 2500);
            }
...
exports.start_reset = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(password, confirmpassword, token) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.alert)('Your password was reset Login again', 'success');
              window.setTimeout(function () {
                window.location.assign('/EC/mainpage');
              }, 2500);
            }
...
exports.update_person = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              window.setTimeout(function () {
                (0, _alert.alert)('Your info is updated ', 'success');
                location.assign("/EC/person/".concat(id));
              }, 1500);
            }
...
exports.register_person = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, email, role, address, phoneNo, Rollno, id) {
    var password, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status == 'success') {
              window.setTimeout(function () {
                (0, _alert.alert)('Your info is updated ', 'success');
                location.assign("/EC/Myteam/".concat(id));
              }, 1500);
            }
...
exports.start_delete = /*#__PURE__*/function () {
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status == 204) {
              (0, _alert.alert)('The info is updated ', 'success');
              window.setTimeout(function () {
...
var forgetpassword = document.querySelector('#forget_password');
var resetpassword = document.querySelector('#resetpassword');
var savePersonalDetails = document.querySelector('#personal-detail');
var saveprofessionaldetails = document.querySelector('#professional-detail');
var deleteuser = document.querySelectorAll('.deleteme');

if (login) {
  login.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.querySelector('#login_emailid').value;
...
if (signup) {
  signup.addEventListener('submit', function (e) {
    ...
    var confirmpassword = document.querySelector('#signup_confirmpassword').value;
    var name = document.querySelector('#signup_name').value;
    var role = document.querySelector('#signup_role').value;
    var worksfor = document.querySelector('#signup_worksfor').value;
    var post = document.querySelector('#signup_post').value;
    (0, _login.start_signup)(name, email, password, confirmpassword, role, worksfor, post);
  });
}
...
if (forgetpassword) {
  forgetpassword.addEventListener('click', function (e) {
    e.preventDefault();
    var email = document.querySelector('#login_emailid').value;
    (0, _login.start_forgetpassword)(email);
  });
}
...
if (resetpassword) {
  resetpassword.addEventListener('submit', function (e) {
    e.preventDefault();
    var password = document.querySelector('#forget_password1').value;
    var confirmpassword = document.querySelector('#forget_password1').value;
    var token = document.querySelector('.resettoken').id;
    (0, _login.start_reset)(password, confirmpassword, token);
  });
}

if (savePersonalDetails) {
  savePersonalDetails.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    var id = document.querySelector('.id__').id;
    (0, _update.update_person)(form, id);
  });
}

if (saveprofessionaldetails) {
  saveprofessionaldetails.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.querySelector('#create-name').value;
    var email = document.querySelector('#create-email').value;
    var role = document.querySelector('#type').value;
    var address = document.querySelector('#create-address').value;
    var phoneno = document.querySelector('#create-number').value;
    var rollno = document.querySelector('#create-rollno').value;
    var id = document.querySelector('.id__').id;
    (0, _update.register_person)(name, email, role, address, phoneno, rollno, id);
  });
}
